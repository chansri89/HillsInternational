<%@ page title="" language="C#" masterpagefile="~/MasterPage3.master" autoeventwireup="true" inherits="A_ProjectInputSheet, App_Web_lkpdlk5o" %>
...
<asp:Label ID="lblPgmHdr" runat="server" Text="" CssClass="XSmall"
         width="889px" Font-Size ="12pt" Font-Bold="True" 
        style="text-align: center" Height="20px"></asp:Label>
        <br />
        <asp:Label ID="Label1" runat="server" CssClass="XSmall" Font-Bold="True" 
         Text = "Load Project Input Sheet for the Selected Project--."
            Width="969px" ForeColor="BlueViolet" Height="26px"></asp:Label>
  
    <div style="height: 95px; width: 1237px;" Class="XSmall">
    <table id="tblFileType" runat="server" style="width: 971px; height: 47px;">
        <tr>
            ...
            <td>
             ...
             <td>
                <asp:DropDownList ID="ddlCompany"  runat="server"  Visible="true" AutoPostBack="true" 
                     OnSelectedIndexChanged="ddlCompanyChanged" Font-Size="X-Small"
             ...
             <td style="width: 100px" class="style21">
                <asp:DropDownList ID="ddlProject"  runat="server"  Font-Size="X-Small"
                     DataTextField="ProjectName" DataValueField="ClientProjectId"
            ...
            <td>
                <asp:FileUpload ID="FlUpdExcel" runat="server" Width="322px" Height="21px" 
                    />
            </td>
            <td>
                <asp:Button ID="btnUpload" runat="server"  
              ForeColor="Black" BackColor="LightBlue" OnClick="btnUpload_Click" Text="Upload" Width="50px" 
              TabIndex="16" />
            </td>
   ...
   <asp:panel ID="pnlSheetName" runat="server" Height="378px" Width="1017px" CssClass="XXSmall" >
    ...
    <asp:Label ID="Label4" runat="server" Text ="Select the Sheets to be Uploaded and mark for OnlyAmount and click Save "
        ...
        <td></td>
        <td>
                <asp:Button ID="btnSave" runat="server" Font-Size="X-Small" 
              ForeColor="Black" BackColor ="Aqua" OnClick="btnSave_Click" Text="Save" Width="56px" 
                         UseSubmitBehavior="false" 
                         OnClientClick="this.Disabled='true'; this.Value='Pls Wait..';"
               />
               </td>
            <td>
                <asp:Button ID="btnDeselect" runat="server"  Font-Size="X-Small" 
              ForeColor="Black" BackColor ="Orange" OnClick="btnDeSelect_Click"  Visible="false"
   ...
   <asp:panel ID="PnlDepotSalesStatus" runat="server" Height="364px" Width="947px" CssClass="XXSmall">
        ...
        <table><tr><td> <b style ="color: #33CC33"> Grid Showing all Rows in Uploaded Status</b></td></tr></table>
           <asp:GridView ID="GrdDepotSalesStatus" runat="server" CellPadding="3" Font-Size="X-Small" 
