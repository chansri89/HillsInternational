<%@ page title="" language="C#" masterpagefile="~/MasterPage1.Master" autoeventwireup="true" inherits="A_ProjectInputIOWCommonFactor, App_Web_sx5sst5a" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


  <asp:Label ID="lblCRAMCommonFactorMaster" runat="server" Align= "center" Text="Project Input IOW Common Factor" 
         width="787px"  Font-Size ="12pt" Font-Bold="True" style="text-align: center"></asp:Label>

    <asp:Panel ID="pnlPendind" runat="server" Height="28px" Width="932px" 
        CssClass="XSmall">
        <table style="height: 22px; width: 797px;">
            <tr>
                      <td  style="width: 70px">
    ...
    <asp:GridView ID="GrdIOWCommonFactor" runat="server" CellPadding="3" 
        ...
        <Columns>
           ...
           <asp:TemplateField HeaderText="ClientCode"  Visible="false">
            <ItemTemplate>
            <asp:Label ID="lblClientCode" runat="server" Text='<%# Eval("ClientCode") %>' ></asp:Label></ItemTemplate>
             <HeaderStyle Width="10px" />
            </asp:TemplateField>
           <asp:TemplateField HeaderText="ProjectCode"  Visible="false">
            <ItemTemplate>
            <asp:Label ID="lblProjectCode" runat="server" Text='<%# Eval("ProjectCode") %>' ></asp:Label></ItemTemplate>
             <HeaderStyle Width="10px" />
            </asp:TemplateField>
           <asp:TemplateField HeaderText="YearMonth"  Visible="false">
            <ItemTemplate>
            <asp:Label ID="lblYearMonth" runat="server" Text='<%# Eval("ForYearMonth") %>' ></asp:Label></ItemTemplate>
             <HeaderStyle Width="10px" />
            </asp:TemplateField>
