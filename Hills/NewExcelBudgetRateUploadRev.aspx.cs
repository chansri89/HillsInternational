...
public partial class NewExcelBudgetRateUploadRev : System.Web.UI.Page
{
    #region Declaration
    #region XL
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                lblPgmHdr.Text = "Priced Estimate BOQ Upload With Multi Sheet";
            }
            catch
            {
            ...
            ddlQuote.SelectedIndex = 2; // Hardcoded for Tender Budget upload
    ...
    private int RevisionChanged()
    {
        ...
        try
        {
            ...
            {
                err = 1;
                ErrText = "Cannot Quote Budget for Revision numbers that are greater than current and Less than or equal to 0 ";
            }
            else
            {
                err = 0;
