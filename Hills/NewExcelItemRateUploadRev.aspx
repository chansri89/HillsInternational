<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="NewExcelItemRateUploadRev.aspx.cs" Inherits="NewExcelItemRateUploadRev" %>
...
<%--<table></table>--%>
    ...
    <asp:Label ID="lblPgmHdr" runat="server" Text="" CssClass="XSmall"
         ...
         <br />
        <asp:Label ID="Label1" runat="server"  Font-Bold="True"     Text = "Excel File Format to be xlsx"
            Width="1074px" ForeColor="BlueViolet" Height="20px"></asp:Label>
  
    <div style="height: 95px; width: 1040px;" CssClass="XXSmall">
    <table id="tblFileType" runat="server" style="width: 889px; height: 47px;">
        <tr>
           ...
           <td>
            ...
            <td>
                <asp:FileUpload ID="FlUpdExcel" runat="server" Width="220px" Height="21px"  />
            </td>
            <td>
                <asp:Button ID="btnUpload" runat="server"    ForeColor="Black" BackColor="LightBlue" OnClick="btnUpload_Click" Text="Upload" Width="50px" 
              TabIndex="16" />
            </td>
           ...
           <td style="text-align: left;  width: 60px;"  align="right">
    ...
    <td style="width: 800px">
     <asp:Label ID="lblMessage" runat="server"  Width="790px" ForeColor="#FF3300" Height="19px"></asp:Label>
   ...
   <asp:panel ID="pnlSheetName" runat="server" Height="460px" Width="1043px" CssClass="XXSmall">
    <table><tr>
    <td style="width: 786px" align="right"> 
    <asp:Label ID="Label4" runat="server" Text ="Select the Sheets to be Uploaded and click Save " 
     ...
     <div style="overflow:auto; height:424px; width:1029px"      title = "SheetName">
       <asp:GridView ID="grdSheetName" runat="server" CellPadding="3"  
             ForeColor="Red"     Width="1009px" AutoGenerateColumns="False" Height="52px" 
...
--%>
   ...
   <asp:panel ID="PnlDepotSalesStatus" runat="server" Height="364px" Width="947px" CssClass="XXSmall">
    ...
    <asp:Label ID="Label2" runat="server" Text ="Grid Showing Data Status ... If in Red Some Rows Status may not be OK "
     ...
     <div style="overflow:auto; height:259px; width:1145px"  title = "OK Data in UpLoad">
       <asp:GridView ID="grdNotOKTeaBoard" runat="server" CellPadding="3"   ForeColor="Red"
            Width="934px"  AutoGenerateColumns="False" Height="37px" 
             GridLines="Vertical" BackColor="White" BorderColor="#999999"    
             BorderStyle="None" BorderWidth="1px" >
        <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />     <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
        <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" /> <SelectedRowStyle BackColor="#008A8C" Font-Bold="True" ForeColor="White" />
   ...
   <asp:panel ID="PnlTeaBoardStatus" runat="server" Height="364px" Width="947px" CssClass="XXSmall">
    ...
    <asp:Label ID="Label3" runat="server" Text ="Grid Showing Data Status ... If in Red Some Rows Status may not be OK "
     ...
     <div style="overflow:auto; height:259px; width:1145px" 
           title = "OK Data in UpLoad">
       <asp:GridView ID="grdNotOkBankReceipt" runat="server" CellPadding="3"   ForeColor="Red"
            Width="1092px"  AutoGenerateColumns="False" Height="37px" 
             GridLines="Vertical" BackColor="White" BorderColor="#999999"  
                BorderStyle="None" BorderWidth="1px" >
        <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />     <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
