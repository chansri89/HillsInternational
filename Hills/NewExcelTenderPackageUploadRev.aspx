<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="NewExcelTenderPackageUploadRev.aspx.cs" Inherits="NewExcelTenderPackageUploadRev" %>
...
<asp:Label ID="lblPgmHdr" runat="server" Text="" CssClass="XSmall"
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True"   Text = "Excel File Format to be xlsx.. Ensure -- No Merged Rows "
            Width="1074px" ForeColor="BlueViolet" Height="20px"></asp:Label>
  
    <div style="height: 95px; width: 1237px;" Class="XXSmall">
    <table id="tblFileType" runat="server" style="width: 1222px; height: 47px;">
        <tr>
             ...
             <td>
                <asp:DropDownList ID="ddlCompany"  runat="server"  Visible="true"
                    DataTextField="CompanyName" DataValueField="CompanyId"
                     Width="133px" AutoPostBack="true" Font-Size="X-Small"
                     OnSelectedIndexChanged="ddlCompanyChanged" height="16px" >
                 </asp:DropDownList>
            </td>
           
           <td>
                <asp:Label ID="lblTransType" runat="server" Text="Client" Visible="true"
                  Font-Bold="true"  ></asp:Label>
           </td>
             <td>
                <asp:DropDownList ID="ddlClient"  runat="server"  Visible="true" 
                     AutoPostBack="true" OnSelectedIndexChanged="ddlClientChanged"
           ...
           <td>
             ...
             <td>
                <asp:DropDownList ID="ddlProject"  runat="server"  Visible="true"
                    ...
                    AutoPostBack="true" OnSelectedIndexChanged="ddlProjectChanged" Font-Size="X-Small"
           ...
           <td>
            ...
            <td>
             ...
             <td>
                <asp:DropDownList ID="ddlQuote"  runat="server"  Visible="true"
                    DataTextField="TenderUpLoadType" DataValueField="TenderUpLoadValue"
                    Width="72px" height="20px"  Font-Size="X-Small" >
            ...
            <td>
                <asp:FileUpload ID="FlUpdExcel" runat="server" Width="213px" Height="21px" 
                    Font-Size="X-Small" />
            </td>
            <td>
                <asp:Button ID="btnUpload" runat="server"  ForeColor="Black" Font-Size="X-Small"
                    BackColor="LightBlue" OnClick="btnUpload_Click" Text="Upload" Width="53px" 
              TabIndex="16" />
            </td>
 
            <td>
                    <asp:TextBox ID="txtWParameterId" runat="server" height="15px" Visible="false"  Width="10px"></asp:TextBox>
                </td>
            <td>
                    <asp:TextBox ID="txtFileName" runat="server" height="15px" Visible="false"   Width="10px"></asp:TextBox>
                </td>
 
           <td style="text-align: left;  width: 10px;"        align="right">
    ...
    <td style="width: 800px">
     <asp:Label ID="lblMessage" runat="server"  
            Width="790px" ForeColor="#FF3300" Height="19px"></asp:Label>

    </td>
    <td>
       <asp:panel ID="Panel1" runat="server" Height="36px" Width="172px" >
       <table> <tr>
       <td>
        <asp:Label ID="lblRevnoChanged" runat="server" Font-Size ="XX-Small" Text="Are You Sure For Changing Revision Number"
            ...
            <td>
             ...
             <td>
                    <asp:TextBox ID="txtSheetName" runat="server" height="15px" Visible="false"   Width="10px"></asp:TextBox>
                </td>
             <td>
   ...
   <asp:panel ID="pnlSheetName" runat="server" Height="337px" Width="1028px" CssClass="XXSmall">
    <table><tr>
    <td style="width: 775px" align="right"> 
    <asp:Label ID="Label4" runat="server" Text ="Select the Sheets to be Uploaded and mark for OnlyAmount and click Save "
     ...
     <div style="overflow:auto; height:301px; width:1017px"      title = "SheetName">
       <asp:GridView ID="grdSheetName" runat="server" CellPadding="3"  ForeColor="Red"   Width="962px"  AutoGenerateColumns="False" Height="52px" 
        ...
        <Columns>
            ...
            <ItemTemplate>
            <asp:Label ID="lblExcelFileName" runat="server" Text='<%# Eval("ExeclFileName") %>' Width="500px" ></asp:Label></ItemTemplate>
            <HeaderStyle Width="500px" /><ItemStyle Width= "500px"   /> 
            </asp:TemplateField>
                <asp:TemplateField HeaderText="Sheet Name" Visible="false" >
            <ItemTemplate>
            <asp:Label ID="lblSheetName" runat="server" Text='<%# Eval("ExeclSheetName") %>' Width="80px" ></asp:Label></ItemTemplate>
            ...
            <ItemTemplate>
            <asp:CheckBox ID="chkOnlyAmount" runat="server" checked = "false"  Width="35px" ></asp:CheckBox></ItemTemplate>
            <HeaderStyle Width="35px" />
            </asp:TemplateField>

            <asp:TemplateField HeaderText="UpLoad Sheet" Visible="true" >
            <ItemTemplate>
            <asp:CheckBox ID="chkUpLoadSheet" runat="server" checked = "true"  Width="35px" ></asp:CheckBox></ItemTemplate>
            <HeaderStyle Width="35px" />
            </asp:TemplateField>
   ...
   <asp:panel ID="PnlDepotSalesStatus" runat="server" Height="364px" Width="947px" CssClass="XXSmall">
        ...
        <table><tr><td> <b style ="color: #33CC33"> Grid Showing all Rows in Uploaded Status</b></td></tr></table>
           <asp:GridView ID="GrdDepotSalesStatus" runat="server" CellPadding="3" 
                Width="921px"  AutoGenerateColumns="False" 
