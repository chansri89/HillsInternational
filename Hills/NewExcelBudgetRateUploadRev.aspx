<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="NewExcelBudgetRateUploadRev.aspx.cs" Inherits="NewExcelBudgetRateUploadRev" %>
...
<asp:Label ID="lblPgmHdr" runat="server" Text="" CssClass="XSmall"
         ...
         <br />
        <asp:Label ID="Label1" runat="server"  Font-Bold="True" CssClass="XSmall"
    ...
    <table id="tblFileType" runat="server" style="width: 1222px; height: 47px;">
        <tr>
            ...
            <td>
             ...
             <td>
                <asp:DropDownList ID="ddlCompany"  runat="server"  Visible="true" Font-Size="X-Small"
                  DataTextField="CompanyName" DataValueField="CompanyId"    Width="138px" AutoPostBack="true" 
           ...
           <td>
                <asp:Label ID="lblTransType" runat="server" Text="Client" Visible="true" Font-Bold="true"  ></asp:Label>
           </td>
             <td>
                <asp:DropDownList ID="ddlClient"  runat="server"  Visible="true" Font-Size="X-Small"
                     AutoPostBack="true" OnSelectedIndexChanged="ddlClientChanged"
                  DataTextField="ClientName" DataValueField="ClientCode"    Width="122px" height="19px"  >
                 </asp:DropDownList>
            </td>

           <td>
                <asp:Label ID="lblProject" runat="server" Text="Project" Visible="true"    Font-Bold="true"  ></asp:Label>
           </td>
             <td>
                <asp:DropDownList ID="ddlProject"  runat="server"  Visible="true"
                   DataTextField="ProjectName" DataValueField="ProjectCode" Font-Size="X-Small"
                    AutoPostBack="true" OnSelectedIndexChanged="ddlProjectChanged"  Width="119px" height="22px"  >
                 </asp:DropDownList>
            </td>
           ...
           <td>
                <asp:TextBox ID="txtPrevRevisionNumber" runat="server" Text="" Visible="true" Enabled="false"   Font-Size="X-Small"
            ...
            <td>
                <asp:TextBox ID="txtNewRevNumber" runat="server" Text="" Visible="true" AutoPostBack="true" OnTextChanged="RevNoChanged"
                  Font-Bold="true"  Width="22px" ></asp:TextBox>
                       ...
                       <td>
                <asp:Label ID="lblQuote" runat="server" Text="Tender" Visible="true" Font-Size="X-Small"
                  Font-Bold="true"  ></asp:Label>
           </td>
             <td>
                <asp:DropDownList ID="ddlQuote"  runat="server"  Visible="true" Font-Size="X-Small"
                   DataTextField="TenderUpLoadType" DataValueField="TenderUpLoadValue"  Width="72px" height="20px"  >
    ...
    <td style="width: 800px">
     <asp:Label ID="lblMessage" runat="server" Font-Size ="XX-Small"
       ...
       <td>
        <asp:Label ID="lblRevnoChanged" runat="server" Text="Are You Sure For Changing Revision Number"
            ...
            <td>
             ...
             <td>
                    <asp:TextBox ID="txtOnlyAmount" runat="server"  height="15px" Visible="false"  Width="10px"></asp:TextBox>
                </td>
            </tr>
        </table>
       </asp:panel>
   ...
   <asp:panel ID="pnlSheetName" runat="server" Height="460px" Width="1043px" CssClass="XXSmall" >
    <table><tr>
    <td style="width: 829px" align="right"> 
    <asp:Label ID="Label4" runat="server" Text ="Select the Sheets to be Uploaded and mark for OnlyAmount and click Save " 
     ...
     <div style="overflow:auto; height:424px; width:1029px"      title = "SheetName">
       <asp:GridView ID="grdSheetName" runat="server" CellPadding="3"  
             ForeColor="Red"   Width="1009px" AutoGenerateColumns="False" Height="52px"   GridLines="Vertical" BackColor="White" BorderColor="#999999"      
