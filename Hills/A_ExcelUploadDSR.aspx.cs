...
public partial class A_ExcelUploadDSR : System.Web.UI.Page
{
    #region Declaration
    #region XL
                ...
                if (UpMsg.Result.Substring(0, 1) == "0")
                {
                   ...
                   // Uploadinsert.Result = "0"; //scs comment this to allow abv 
                    ...
                    else
                    {
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, typeof(string), "Alert", "alert('" + " A_Excel Upload DSR  Insert to tbl Failed while inserting Table...   " + Uploadinsert.Result.Substring(1, Uploadinsert.Result.Length - 1) + "');", true);
                            lblMessage.Text = " A_Excel Upload DSR Insert to tbl Failed while inserting Table...   " + Uploadinsert.Result.Substring(1, Uploadinsert.Result.Length - 1); //scs 251215
                            pnlSheetName.Visible = false;
                        }
                        else
                        {
        ...
        foreach (DataRow dr in dtCoup.Rows)
        {
           ...
           // string WDate = ""; string sDate = ""; //string WChar = "";
            ...
            if (linecount > 1) // Upload as is else if header is specified then make >=1
            {
                ...
                #region DSRH
                        if ((dr[0].ToString() != string.Empty && dr[2].ToString() != string.Empty && dr[4].ToString() != string.Empty
                            && TranType.ToUpper() == "DSRH")) //season,Auctiondate,INvnumber,Dealprice
                        {
                            excelUpload.Column1 = linecount.ToString(); // xl row number
                            excelUpload.Column2 = (dr[0].ToString() == null || dr[0].ToString() == string.Empty) ? string.Empty : dr[0].ToString(); // Grp
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column2);
                            excelUpload.Column2 = RemovedCharColumn;
                            excelUpload.Column3 = (dr[1].ToString() == null || dr[1].ToString() == string.Empty) ? string.Empty : dr[1].ToString(); // grpName
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column3);
                            excelUpload.Column3 = RemovedCharColumn;
                            excelUpload.Column4 = (dr[2].ToString() == null || dr[2].ToString() == string.Empty) ? string.Empty : dr[2].ToString(); //subgrp
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column4);
                            excelUpload.Column4 = RemovedCharColumn;
                            excelUpload.Column5 = (dr[3].ToString() == null || dr[3].ToString() == string.Empty) ? string.Empty : dr[3].ToString(); // subgrpname
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column5);
                            excelUpload.Column5 = RemovedCharColumn;
                            excelUpload.Column6 = (dr[4].ToString() == null || dr[4].ToString() == string.Empty) ? string.Empty : dr[4].ToString(); // IOWCd
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column6);
                            excelUpload.Column6 = RemovedCharColumn;
                            try
                            {
                                excelUpload.Column7 = (dr[5].ToString() == null || dr[5].ToString() == string.Empty) ? string.Empty : dr[5].ToString(); //IOWNAme
                            ...
                            try
                            {
                                excelUpload.Column8 = (dr[6].ToString() == null || dr[6].ToString() == string.Empty) ? string.Empty : dr[6].ToString(); // StarItem
                ...
                #region DSRI
                        if ((dr[0].ToString() != string.Empty && dr[2].ToString() != string.Empty && dr[4].ToString() != string.Empty
                            && TranType.ToUpper() == "DSRI")) //season,Auctiondate,INvnumber,Dealprice
                        {
                            excelUpload.Column1 = linecount.ToString(); // xl row number
                            excelUpload.Column2 = (dr[0].ToString() == null || dr[0].ToString() == string.Empty) ? string.Empty : dr[0].ToString(); // Grp
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column2);
                            ...
                            try
                            {
                                excelUpload.Column8 = (dr[6].ToString() == null || dr[6].ToString() == string.Empty) ? string.Empty : dr[6].ToString(); // IOWqty
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column8);
                                excelUpload.Column8 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column12 = (dr[10].ToString() == null || dr[10].ToString() == string.Empty) ? "" : dr[10].ToString(); //LSP_SP
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column12);
                                excelUpload.Column12 = RemovedCharColumn;
                            }
                            catch
                ...
                #region BASIC
                        if ((dr[0].ToString() != string.Empty && dr[2].ToString() != string.Empty && dr[4].ToString() != string.Empty
                            && dr[5].ToString() != string.Empty  && TranType.ToUpper() == "BASIC")) //season,Auctiondate,INvnumber,Dealprice
                        {
                            excelUpload.Column1 = linecount.ToString(); // xl row number
                            excelUpload.Column2 = (dr[0].ToString() == null || dr[0].ToString() == string.Empty) ? string.Empty : dr[0].ToString(); // Grp
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column2);
                            ...
                            try
                            {
                                excelUpload.Column10 = (dr[8].ToString() == null || dr[8].ToString() == string.Empty) ? string.Empty : dr[8].ToString(); //Remarks
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column10);
                                excelUpload.Column10 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column11 = (dr[9].ToString() == null || dr[9].ToString() == string.Empty) ? string.Empty : dr[9].ToString(); //LSP_SP
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column11);
                                excelUpload.Column11 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column12 = (dr[10].ToString() == null || dr[10].ToString() == string.Empty) ? string.Empty : dr[10].ToString(); //LSP_SP
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column12);
                                excelUpload.Column12 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column13 = (dr[11].ToString() == null || dr[11].ToString() == string.Empty) ? string.Empty : dr[11].ToString(); //Buyer
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column13);
                                excelUpload.Column13 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column14 = (dr[12].ToString() == null || dr[12].ToString() == string.Empty) ? string.Empty : dr[12].ToString(); //  Auctioneer Name
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column14);
                                excelUpload.Column14 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column15 = (dr[13].ToString() == null || dr[13].ToString() == string.Empty) ? string.Empty : dr[13].ToString(); // TeaType
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column15);
                                excelUpload.Column15 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column16 = (dr[14].ToString() == null || dr[14].ToString() == string.Empty) ? string.Empty : dr[14].ToString(); // CAtegory
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column16);
                                excelUpload.Column16 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column17 = (dr[15].ToString() == null || dr[15].ToString() == string.Empty) ? string.Empty : dr[15].ToString(); // Origion
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column17);
                                excelUpload.Column17 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column18 = (dr[16].ToString() == null || dr[16].ToString() == string.Empty) ? string.Empty : dr[16].ToString(); // Origion
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column18);
                                excelUpload.Column18 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column19 = (dr[17].ToString() == null || dr[17].ToString() == string.Empty) ? string.Empty : dr[17].ToString(); // Origion
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column19);
                                excelUpload.Column19 = RemovedCharColumn;
                            }
                            catch
                            {
                            ...
                            //try
                            //{
                            //    excelUpload.Column20 = (dr[18].ToString() == null || dr[18].ToString() == string.Empty) ? string.Empty : dr[18].ToString(); // Origion
                            //    RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column20);
                            //    excelUpload.Column20 = RemovedCharColumn;
                            //}
                            //catch
                            //{
                        ...
                        #endregion
                #region DAR
                        if ((dr[0].ToString() != string.Empty && dr[1].ToString() != string.Empty && dr[2].ToString() != string.Empty
                            && TranType.ToUpper() == "DAR")) //season,Auctiondate,INvnumber,Dealprice
                        {
                            excelUpload.Column1 = linecount.ToString(); // xl row number
                            excelUpload.Column2 = (dr[0].ToString() == null || dr[0].ToString() == string.Empty) ? string.Empty : dr[0].ToString(); // iowcode
                            //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column2);
                            //excelUpload.Column2 = RemovedCharColumn;
                            excelUpload.Column3 = (dr[1].ToString() == null || dr[1].ToString() == string.Empty) ? string.Empty : dr[1].ToString(); // srlno
                            //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column3);
                            //excelUpload.Column3 = RemovedCharColumn;
                            excelUpload.Column4 = (dr[2].ToString() == null || dr[2].ToString() == string.Empty) ? string.Empty : dr[2].ToString(); //context
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column4);
                            excelUpload.Column4 = RemovedCharColumn;
                            excelUpload.Column5 = (dr[3].ToString() == null || dr[3].ToString() == string.Empty) ? string.Empty : dr[3].ToString(); // ItemCode
                            //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column5);
                            //excelUpload.Column5 = RemovedCharColumn;
                            excelUpload.Column6 = (dr[4].ToString() == null || dr[4].ToString() == string.Empty) ? string.Empty : dr[4].ToString(); // itemMakecd
                            RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column6);
                            excelUpload.Column6 = RemovedCharColumn;
                            try
                            {
                                excelUpload.Column7 = (dr[5].ToString() == null || dr[5].ToString() == string.Empty) ? string.Empty : dr[5].ToString(); //Reg
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column7);
                                //excelUpload.Column7 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column8 = (dr[6].ToString() == null || dr[6].ToString() == string.Empty) ? string.Empty : dr[6].ToString(); // ItemName
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column8);
                                //excelUpload.Column8 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column9 = (dr[7].ToString() == null || dr[7].ToString() == string.Empty) ? string.Empty : dr[7].ToString(); //UOM
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column9);
                                //excelUpload.Column9 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column10 = (dr[8].ToString() == null || dr[8].ToString() == string.Empty) ? " " : dr[8].ToString(); //qty
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column10);
                                //excelUpload.Column10 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column11 = (dr[9].ToString() == null || dr[9].ToString() == string.Empty) ? "" : dr[9].ToString(); //wastage
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column11);
                                //excelUpload.Column11 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column12 = (dr[10].ToString() == null || dr[10].ToString() == string.Empty) ? "" : dr[10].ToString(); //Rate
                                //RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column12);
                                //excelUpload.Column12 = RemovedCharColumn;
                            }
                            catch
                            ...
                            try
                            {
                                excelUpload.Column13 = (dr[11].ToString() == null || dr[11].ToString() == string.Empty) ? "" : dr[11].ToString(); //Amt
                                RemovedCharColumn = RemoveUnWantedCharacter(excelUpload.Column13);
                                excelUpload.Column13 = RemovedCharColumn;
                            }
                            catch
